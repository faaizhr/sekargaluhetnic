            ...
            <div>
              ...
              <div className="h-96">
                {dataChat?.sekargaluhetnic_chat_jahit?.map((el) => 
                  <div key={el.id} className={el.user_id == Cookies.get("okogaye") ? "bg-secondary text-white px-3 py-2 w-3/4 flex justify-end mb-1 ml-auto mr-0 rounded-tl-xl rounded-bl-xl rounded-br-xl" : "bg-primary text-white px-3 py-2 w-3/4 flex justify-start mb-1 ml-0 mr-auto rounded-tr-xl rounded-bl-xl rounded-br-xl"}>
